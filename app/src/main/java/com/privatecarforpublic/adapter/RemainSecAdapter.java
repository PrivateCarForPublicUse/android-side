...
public class RemainSecAdapter extends BaseAdapter{
    ...
    public RemainSecAdapter(Context _context, List<SecRoute> _list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.remain_sec_item, parent, false);
